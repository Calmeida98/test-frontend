<template>
  ...
  >
    ...
    <slot :slot="'apellidos'" slot-scope='record' name='apellidos' :record='record'/>
    <slot :slot="'edad'" slot-scope='record' name='edad' :record='record'/>
    <slot :slot="'sexo'" slot-scope='record' name='sexo' :record='record'/>
